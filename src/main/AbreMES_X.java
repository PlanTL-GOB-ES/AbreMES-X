...
public class AbreMES_X {
	...
	public AbreMES_X(String mainDirectory)
	{
	...
	public static void main(String[] args) throws IOException, ParserConfigurationException, SAXException {
		...
		AbreMES_X allie = new AbreMES_X(mainDirectory);
		allie.start();
	}
	...
	public void printPreprocessedDatabase() throws IOException 
	{
		...
		writer.write("# Line num." + "\t" + "Pub. ID" + "\t" + "Source" + "\t" + "Year" + "\t" + "Abbreviation ID" + "\t" + "Definition ID"
